...
export class AddressService {
  ...
  getAllShippingAddressesByUser(): Observable<ShippingAddress[]> {
    return this.http.get(this.REST_API_URL + 'ShippingAddresses').pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  //get shipping address of a user by uid
  getShippingAddressByUserId(uid: number): Observable<ShippingAddress[]> {
    return this.http
      .get(this.REST_API_URL + 'ShippingAddresses/user/' + uid)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  getShippingAddressById(SHid: number | null): Observable<ShippingAddress> {
    return this.http.get(this.REST_API_URL + 'ShippingAddresses/' + SHid).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  addShippingAddress(shippingAddress: ShippingAddress): any {
    return this.http
      .post(this.REST_API_URL + 'ShippingAddresses', shippingAddress)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  deleteShippingAddress(SHid: number): any {
    return this.http
      .delete(this.REST_API_URL + 'ShippingAddresses' + SHid)
      .pipe(
        map((res: any) => {
          return res;
        })
